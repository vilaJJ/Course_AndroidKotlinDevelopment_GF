...
private fun isTipoConviteValido(tipoConviteId: Int) = tipoConviteId in 1..3

private fun isCodigoConviteValido(tipoConviteId: Int, conviteCode: String): Boolean {
