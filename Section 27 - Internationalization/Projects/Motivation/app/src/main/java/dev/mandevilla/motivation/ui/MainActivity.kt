...
import dev.mandevilla.motivation.business.PhraseBusiness
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val phraseBusiness = PhraseBusiness()
    ...
    private fun handleNewPhrase() {
        val phrase = phraseBusiness.getPhrase(phraseOption)
        binding.textPhrase.text = phrase ?: getString(R.string.phrase_not_found)
    }
